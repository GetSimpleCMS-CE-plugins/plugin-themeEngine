	...
	<div class="wrapper">
		<div id="maincontent">
			<div class="main" style="border:none;">
							...
							foreach ((array) $dirsSorted as $upload) {
								...
								<tr class="All">
									<td class="" colspan="5">
										...
										<a href="imagebrowser.php?path=<?php echo $p; ?>&amp;func=<?php echo $func; ?>&amp;w=<?php echo $w; ?>&amp;h=<?php echo $h; ?>&autoclose=1&CKEditor=post-content&func=<?php echo $_GET['func']; ?>"
				...
				<p><em><b><?php echo count((array) $filesSorted); ?></b> <?php i18n('TOTAL_FILES'); ?>
						(<?php echo fSize($totalsize); ?>)</em></p>
